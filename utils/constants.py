...
UNIT_TAGS = getJson(
    os.getenv("DATAMINE_LOCATION") + "/char.vromfs.bin_u/config/unittags.blkx"
)
...
MODIFICATIONS: dict = getJson(
    os.getenv("DATAMINE_LOCATION") + "/char.vromfs.bin_u/config/modifications.blkx"
)["modifications"]
